...
std::map<int, Histogram> *compute_histogram_frames_ROI (const Parameters &parameters, int indexROI);
 ...
 */
std::vector<QVector<double> > *compute_pixel_count_difference_light_calibrated_most_common_colour (const Experiment &experiment, int x1, int y1, int x2, int y2);
